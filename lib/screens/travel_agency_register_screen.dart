...
class TravelAgencyRegisterScreen extends StatefulWidget {
  const TravelAgencyRegisterScreen({super.key});

  @override
  State<TravelAgencyRegisterScreen> createState() => _TravelAgencyRegisterScreenState();
}

class _TravelAgencyRegisterScreenState extends State<TravelAgencyRegisterScreen> {
  final TextEditingController _nameController = TextEditingController();
  final TextEditingController _emailController = TextEditingController();
  final TextEditingController _phoneController = TextEditingController();
  final TextEditingController _locationController = TextEditingController();
  final TextEditingController _licenseController = TextEditingController(); // For Fleet/Agency Reg No.
  ...
  void _register() async {
    ...
    if (name.isEmpty || email.isEmpty || password.isEmpty || phone.isEmpty || location.isEmpty || license.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please fill all fields including Registration No.')),
      );
      return;
    }
    ...
    bool success = await authProvider.signUp(
      ...
      password: password,
      phone: phone,
      role: 'travel_agency', // Setting the role specifically for travel partners
      location: location,
    );
                    ...
                    child: IntrinsicHeight(
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildInputField(hint: 'Agency Name', icon: Icons.local_shipping_outlined, controller: _nameController),
                          ...
                          const SizedBox(height: 12),
                          _buildInputField(hint: 'Location / Base City', icon: Icons.location_on_outlined, controller: _locationController),
                          const SizedBox(height: 12),
                          _buildInputField(hint: 'Fleet / Agency Reg No.', icon: Icons.verified_outlined, controller: _licenseController), 
                          const SizedBox(height: 12),
                          ...
                          const Spacer(flex: 2), // Pushes the bottom link down smoothly
