  ...
  void _register() async {
    ...
    if (success) {
      Navigator.pushAndRemoveUntil(
        context,
        MaterialPageRoute(builder: (_) => const ProfileSetupScreen(role: 'travel_agency')),
        (route) => false,
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
                    ...
                    child: IntrinsicHeight(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Create an account to join the logistics network.",
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () async {
                              bool success = await authProvider.signInWithGoogle(role: 'travel_agency');
                              if (!context.mounted) return;
                              ...
                              GestureDetector(
                                onTap: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(builder: (context) => const TravelAgencyLoginScreen()),
                                  );
                                },
                                child: Text(
                                  'Log in',
