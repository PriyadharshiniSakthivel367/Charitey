...
//                     action buttons, image upload, logout)
...
class ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<DocumentSnapshot?>(
      ...
      builder: (context, userSnapshot) {
        ...
        return Container(
          // Elegant dusky rose gradient background
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              colors: [
                Color(0xFFFDF7F8), // Very soft, almost white top-left
                Color(0xFFEEDAE0), // Elegant dusky rose bottom-right
              ],
                    ...
                    child: Column(
                      children: [
                            ...
                            children: [
                              Transform.translate(
                                ...
                                child: GestureDetector(
                                  // Own profile → tap to upload image
                                  // Visited profile with image → tap to view full screen
                                  onTap: isVisiting
                                      ? (profileImage.isNotEmpty
                                          ? () => _openImageViewer(
                                              context, profileImage, name)
                                          : null)
                                      : _pickAndUploadImage,
                                  child: CircleAvatar(
                                    radius: 54,
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        // Favourite toggle (visiting an NGO)
                        ...
                        if (!isVisiting) ...[
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              _buildActionButton(
                                "Favorites",
                                Icons.favorite_border,
                                () => _showFavoriteNgosSheet(context),
                              ),
                              _buildActionButton(
                                "Share",
                                Icons.share,
                          ...
                          Row(
                            children: [
                              // Dynamic donations/requests count
                              if (role == 'ngo')
                          ...
                          // Recent Activity section (own profile)
                          _buildSectionTitle("Recent Activity"),
                          const SizedBox(height: 12),
                          _buildActivityTile(
                            "Donated to Aishwaryam NGO",
                            "2 days ago",
  ...
  Widget _buildActivityTile(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border:
            Border.all(color: themeColor.withValues(alpha: 0.1)),
      ),
      child: Row(
        children: [
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Icon(icon,
              size: 16,
              color: isHighlight ? themeColor : Colors.grey),
  ...
  /// Pick an image from gallery and upload it (own profile only).
  ...
  /// Open full-screen image viewer (visited profile).
  ...
  // ============================================================
  // BOTTOM SHEET — FAVORITE NGOs (DONOR)
  // ============================================================
  Future<void> _showFavoriteNgosSheet(
      BuildContext context) async {
...
class DonationShareTemplate extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration:
          const BoxDecoration(color: Color(0xFFFDF7F8)),
      child: Container(
